...
sleep 2
$CAN_DIR/drv_sja1000/qnx/can_man -n /dev/can2 -s 250 -i 7 -p 0xda200 -e 1 &
sleep 2
$CAN_DIR/jbus/src/qnx/rdj1939 -v -c -f /dev/can2
#$CAN_DIR/jbus/src/qnx/rdj1939 -v -g -c -f /dev/can2
